;;; This is manually downloaded from Emacs master (d76d7a3b) to overwrite the built-in from Emacs 28
(when (> emacs-major-version 28) (error "Remove whitespace.el which is (temporarily) overwriting the emacs built-in."))
